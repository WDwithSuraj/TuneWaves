...
export const AdminSongCard = ({ music, getMusicData }) => {
  ...
  function handleUpdate(id) {
    // alert(id)
    axios.put(`https://cute-lime-sweatpants.cyclic.app/tuneWaves/songs/update/${id}`, songUpdate, { headers })
      .then(() => getMusicData())
      .then(() => onClose())
    toast({
      title: 'Song Updated',
  ...
  function handleDelete(id) {
    // alert(id)
    axios.delete(`https://cute-lime-sweatpants.cyclic.app/tuneWaves/songs/delete/${id}`, { headers })
      .then(() => getMusicData())
